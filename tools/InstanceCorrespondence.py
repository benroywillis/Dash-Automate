...
def PlotConfusionMatrix(dataMap):
	...
	with open("Data/InstanceConfusionMatrix_"+str(RD.buildFolders)[0]+".csv", "w") as f:
		f.write(csvString)
...
#BBC.PlotBasicBlockCorrespondence(matched)
PlotConfusionMatrix(matched)
