...
def argumentParse():
    ...
    arg_parser.add_argument("-dp", "--delete-profile", default=False, action="store_true", help="Delete profiles during build flow.")
    ...
    arg_parser.add_argument("-cp", "--compiler-toolchain-prefix", default="/mnt/heorot-10/bwilli46/Installs/LLVM9/release/", help="Specify path to the LLVM toolchain installation.")
